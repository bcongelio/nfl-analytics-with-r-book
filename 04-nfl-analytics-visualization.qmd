...
After the process finishes running (it may take a while depending on your computing power), we create a new column titled `new_image_path` and use `past0` to copy the `receiver_id` for each player and tag ".png" on the end.
