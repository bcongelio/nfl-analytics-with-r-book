...
![](images/finished-aggressiveness.png){fig-align="center" width="440"}
...
play_action_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/play_action_data.csv")
```
...
```{r add-breaks-with-scales, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r add-commas-to-values, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r using-labs-for-title-caption-sub, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r add-avg-lines-incorrectly, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r correctly-adding-avg-lines, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r mean-lines-with-nflplotr, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r using-theme-to-remove-ticks, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
ggplot(data = play_action_data, aes(x = yds, y = pa_yds)) +
  geom_mean_lines(aes(v_var = yds, h_var = pa_yds), 
                  size = 0.8,
                  color = "black", 
...
```{r adding-theme-elements-to-plot, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r showcasing-use-of-theme, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400 }
...
```{r theme-code-with-modification, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
team_playaction <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/team_playaction.csv")
```
...
```{r building-initial-team-pa, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r adding-logos-without-aspect, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r placing-logos-with-correct-asp, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
eagles_fourth_downs <-
  vroom::vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/eagles_fourth_downs.csv")
```
...
```{r finished_eagles_line, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
combined_fourth_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/combined_fourth_data.csv")
```
...
```{r finished_two_line, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
mahomes_epa <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/mahomes_epa.csv")
```
...
```{r mahomes_epa_finished, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
qb_thirddown_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/qb_thirddown_plot.csv")
```
...
```{r geom_col_cleaning_scales, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r geom_col_adding_names, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r geom_col_adding_headshots, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r geom_col_final, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
epa_per_play <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/epa_per_play.csv")
```
...
```{r epa_per_play_plot, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
playoff_airyards_plot <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/playoff_airyards_plot.csv")
```
...
```{r finished_boxplot, output = TRUE, error = FALSE, fig.align='center', fig.dpi = 400}
...
playoff_airyards_ridges_plot <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/playoff_airyards_ridges_plot.csv")
```
...
```{r finished_geom_ridges, output = TRUE, fig.align='center', error = FALSE, fig.dpi = 400}
...
yards_gained_compared <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/yards_gained_compared.csv")
```

```{r violin_plot_completed, output = TRUE, fig.align='center', error = FALSE, fig.dpi = 400}
...
def_yards_allowed <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/def_yards_allowed.csv")
```
...
complete_wr_airyards <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/complete_wr_ay.csv")
...
```{r finished_kernel_density, output = TRUE, warning = FALSE, error = FALSE, fig.align='center', fig.dpi = 400}
...
pure_cpoe <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/pure_cpoe.csv")
```
...
```{r show_gt_table_1, echo = FALSE}
knitr::include_graphics(rep("images/gt_table_1.png"))
```
...
knitr::include_graphics(rep("images/gt_table_2.png"))
```
...
knitr::include_graphics(rep("images/gt_table_3.png"))
```
...
knitr::include_graphics(rep("images/gt_table_4.png"))
```
...
knitr::include_graphics(rep("images/gt_table_5.png"))
```
