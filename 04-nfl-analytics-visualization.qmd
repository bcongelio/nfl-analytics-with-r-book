...
```{r example-pa-action-plot, output = TRUE, fig.align='center', fig.dpi = 400}
...
```{r mean-lines-with-nflplotr, output = TRUE, error = FALSE, message = FALSE, warning = FALSE, fig.align='center', fig.dpi = 400}
...
```{r showcasing-use-of-theme, output = TRUE, error = FALSE, warning = FALSE, message = FALSE,  fig.align='center', fig.dpi = 400 }
...
```{r theme-code-with-modification, output = TRUE, error = FALSE, warning = FALSE, message = FALSE, fig.align='center', fig.dpi = 400}
...
```{r eagles-line-3, output = TRUE, fig.align='center', warning = FALSE, message = FALSE, error = FALSE, fig.dpi = 400}
...
```{r mahomes_epa_finished, output = TRUE, error = FALSE, fig.align='center', warning = FALSE, message = FALSE, fig.dpi = 400}
...
```{r violin_plot_completed, output = TRUE, fig.align='center', error = FALSE, warning = FALSE, message = FALSE, fig.dpi = 400}
...
In most cases, you will be able to save your plot using just the `filename` and `dpi` arguments, like below the below example:
...
```{r finished_kernel_density, output = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.align='center', fig.dpi = 400}
