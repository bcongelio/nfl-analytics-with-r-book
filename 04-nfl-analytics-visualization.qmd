...
```{r adding-team-color-no-nflplotr, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r incorrect-use-of-aes, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r adding-color-with-nflplotr, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r adding-shape-21-to-plot, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r incorrect-use-of-sizing, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r adding-correct-size-to-points, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r basic-addition-of-player-name, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r add-ggrepel-options, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r add-breaks-with-scales, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r add-commas-to-values, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r using-labs-for-title-caption-sub, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r add-avg-lines-incorrectly, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r correctly-adding-avg-lines, output = TRUE, fig.align='center', fig.dpi = 300}
...
```{r gathering-team-play-action, eval = TRUE, echo = TRUE, output = TRUE}
