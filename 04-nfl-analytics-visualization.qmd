...
```{r finished_eagles_line, eval = TRUE, echo = TRUE, output = TRUE}
...
```{r finished_two_line, eval = TRUE, echo = TRUE, output = TRUE}
...
## Bootstrapping and Visualization with `ggplot2()`

Introduction to bootstrapping here.
