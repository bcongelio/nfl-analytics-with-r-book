...
simple_regression_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/simple_regression_data.csv")
```
...
```{r simple-linear-lobf, output = TRUE, message = FALSE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r plotting-residual-values, output = TRUE, message = FALSE, error = FALSE, fig.align='center', fig.dpi = 400}
...
multiple_lm_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/multiple_lm_data.csv")
...
```{r multiple-regression-plot, output = TRUE, message = FALSE, error = FALSE, fig.align='center', fig.dpi = 400}
...
```{r building-corr-matrix, output = TRUE, message = FALSE, error = FALSE, fig.align='center', fig.dpi = 400}
...
pfr_mvp_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/pfr_mvp_data.csv")
...
model_data <-
  arrow::read_parquet("./example_data/csv/model_data_clean.parquet")
```
...
rushing_kmeans_data <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/rushing_kmeans_data.csv")
```
