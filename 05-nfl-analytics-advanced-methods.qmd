...
According to our fully trained and tested model, fictional quarterback #2 has almost a 76% probability of winning the MVP when compared to the two other opposing quarterbacks.
...
ggplot(data = for_plot, aes(x = yards, y = exp_yards)) +
  ...
  geom_text_repel(data = filter(for_plot, yards >= 4600),
                  ...
                  family = "Roboto Condensed", size = 4, fontface = "bold")
```
...
ggplot(diff_per_season, aes(x = yards, y = exp_yards)) +
  ...
  geom_label_repel(data = subset(diff_per_season, is_max_diff == 1),
                  ...
                  family = "Roboto Condensed", size = 3.5, fontface = "bold") +
  ...
  nfl_analytics_theme() +
  theme(strip.text = element_text(face = "bold", family = "Roboto Condensed", size = 12),
...
ggplot() +
  ...
  annotate(geom = "text", label = "Cumulative Actual Yards", x = 200, y = 1050,
           angle = 38, family = "Roboto Condensed", size = 5) +
  annotate(geom = "text", label = "Cumulative Expected Yards", x = 200, y = 700,
           angle = 35, family = "Roboto Condensed", size = 5) +
