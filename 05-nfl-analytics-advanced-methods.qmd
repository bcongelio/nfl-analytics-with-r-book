...
```{r simple-linear-lobf, output = TRUE, fig.align='center', fig.dpi = 400}
...
```{r rb-kmean-table, eval = TRUE, echo = TRUE, output = FALSE}
...
![](images/rushers_tables.png){fig-align="center" width="6in"}
...
```{r ryoe-season-leaders-plot, output = FALSE, fig.align='center', fig.dpi = 400}
...
![](images/ryoe_per_season.png){fig-align="center" width="6in"}
