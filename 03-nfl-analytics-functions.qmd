...
```{r running-back-40-plot, output = TRUE, fig.align='center', error = FALSE, fig.dpi = 400}
...
```{r ngs-passing-plot, output = TRUE, fig.align='center', error = FALSE, fig.dpi = 400}
...
```{r ngs-rushing-plot, output = TRUE, fig.align='center', error = FALSE, fig.dpi = 400}
...
```{r qbr-adjusted-plot, output = TRUE, fig.align='center', error = FALSE, fig.dpi = 400}
