...
Despite much of the media focus being on the Rams' poor performance, given their title of defending Super Bowl Champions, the Arizona Cardinals have just as many unique offensive line combinations nearing the end of the 2022 season. It makes sense, then, that both teams headed into week 16 of the season with identical 4-10 (.286) records.
...
```{r rendering-ggplot-theme, echo = FALSE, output = FALSE}
...
```{r placeholding-next-example, echo = TRUE, output = FALSE}
...
ggplot(testing, aes(y = reorder(posteam, percent_w_exp), x = percent_w_exp)) +
