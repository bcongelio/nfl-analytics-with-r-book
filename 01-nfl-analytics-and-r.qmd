...
Given that context, just *how* historically bad was the Rams' 2022 offensive line turnover? We can begin by diving into the data to find our results and build our story.
...
With the data cleaned and prepared, we are now able to take our first look at the results. In the code below, we are grouping by all 32 NFL teams and then summarizing the total number of unique offensive line combinations used during the 2022 regular season.
