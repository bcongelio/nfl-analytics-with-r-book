...
```{r plot-combos, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE, warning = FALSE, message = FALSE}
...
```{r finished-cow-plot, echo = FALSE}
knitr::include_graphics("images/cow_plot_finished.png",
                        dpi = 400)
```
