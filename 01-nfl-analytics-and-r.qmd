...
```{r plot-combos, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r plot-pressure-rate, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r plot-combos-qb-hits, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
adjusted_sack_rate <- 
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/adjusted_sack_rate.csv")
```

```{r asr-2022-plot, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r asr-facet-plot, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
fb_outsiders_oline <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/fboutsiders_line_stats.csv")
...
```{r power-and-stuff-cowplot, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
```{r adj-yard-line-plot, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
...
oline_combo_elusive <-
  vroom("https://raw.githubusercontent.com/bcongelio/nfl-analytics-with-r-book/origin/example_data/csv/online_combo_elusive.csv")
```
...
```{r plotting-weighted-elusive, output = TRUE, fig.align='center', fig.dpi = 400, error = FALSE}
